    ...
    <main className="w-[80%] mx-auto mt-20 py-5 max-w-7xl">
      <div className="mb-14">
        ...
        <p className="leading-loose font-Playpen">
          Rocketry stands at the forefront of humanity's exploration of space,
      ...
      <div className="mb-14">
        <h2 className="text-4xl mb-5 text-DarkSlateGray font-bold">
          Milestones in Rocketry:
        </h2>
        <p className="leading-loose font-Playpen">
          The annals of rocketry are etched with historic milestones that have
      ...
      <div className="mb-14">
        ...
        <p className="leading-loose font-Playpen">
          In the realm of modern rocketry, propulsion technologies have
      ...
      <div className="mb-14">
        ...
        <p className="leading-loose font-Playpen">
          A paradigm shift in rocketry occurred with the introduction of
      ...
      <div className="mb-14">
        ...
        <p className="leading-loose font-Playpen">
          As we gaze into the future of rocketry, a constellation of tantalizing
