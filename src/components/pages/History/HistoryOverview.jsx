    ...
    <main className="w-[80%] mx-auto mt-20 py-5 max-w-7xl">
      <div className="mb-14">
        ...
        <p className="leading-loose font-Playpen">
          Sputnik 1, the world's first artificial satellite, marked the dawn of
      ...
      <div className="mb-14">
        ...
        <p className="leading-loose font-Playpen">
          Yuri Gagarin, the first human to journey into space, stands as an
      ...
      <div className="mb-14">
        ...
        <div className="mb-5 max-w-xl">
          <img
            className="w-full h-full object-cover"
            src={buzzAldrinMoonLanding}
            alt="Mars size comparison"
          />
        </div>
        <p className="leading-loose font-Playpen">
          The Apollo program stands as an unparalleled chapter in the history of
      ...
      <div className="mb-14">
        ...
        <p className="leading-loose font-Playpen">
          The Space Shuttle era, spanning from 1981 to 2011, represented a
      ...
      <div className="mb-14">
        <h2 className="text-4xl mb-5 text-DarkSlateGray font-bold">Beyond Earth's Horizon: A Unified Legacy from Sputnik to Mars</h2>
        <p className="leading-loose font-Playpen">
          The collective achievements of Sputnik 1, Yuri Gagarin's pioneering
