...
const Exoplanets = () => {
  ...
  return (
    <main className="w-full h-min my-10">
      <div className="w-full grid place-content-center mb-10 h-40 bg-DarkSlateGray">
        <h1 className="text-Silver text-4xl font-Playpen">Alien Worlds</h1>
      </div>
      <div className="w-full gap-5 flex justify-evenly items-center flex-col flex-wrap">
        <h2 className="font-bold text-2xl text-center">Exoplanets can categorized into 3 main classes</h2>
        {typesOfExoplanets.map(type => {
          const {id, name, img} = type
          return (
            <div key={id} className="w-60 h-64 relative cursor-pointer bg-[white]">
